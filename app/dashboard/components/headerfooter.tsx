      ...
      <div className="pt-2 pb-2 sticky top-0 z-50 border-b border-t bg-gray-700 text-white shadow-2xl "> 
        <div className="flex justify-between"> {/* This is for fixing and positioning*/}
          ...
          <nav className=" mr-4 text-lg pt-1 pb-1 gap-2 mt-1 mb-1 transition-transform duration-300 ease-in-out 
            ...
            <Link className="p-2 rounded mr-2 hover:bg-orange-500 font-serif" href="/dashboard/about">About</Link>
            <Link className="p-2 rounded mr-2 hover:bg-orange-500 font-serif" href="/dashboard/contact">Contact</Link>
          </nav>
        </div>
      </div>
