...
export default function Home() {
  return (
    <div className="flex flex-col items-center h-screen justify-center min-h-screen py-2">
      ...
      profContactClassName="bg-gray-300/300! h-full! md:h-35! border-0! shadow-orange-300/300! flex! flex-col! gap-2! items-center! justify-center! hover:scale-100! overflow-visible!"
